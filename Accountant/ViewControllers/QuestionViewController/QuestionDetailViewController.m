...
{
    if (section == 1) {
        if ([[QuestionManager sharedManager] getDetailQuestionReplyArray].count != 0) {
...
//            [bgView addSubview:topLineView];
            ...
            UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(lineView.frame.origin.x + 15, 20, 100, 20)];
            ...
            UIView *bgView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, 1)];
            UIView *topLineView = [[UIView alloc] initWithFrame:CGRectMake(20, 0, kScreenWidth-20, 1)];
            topLineView.backgroundColor = kTableViewCellSeparatorColor;
            [bgView addSubview:topLineView];
            return bgView;
